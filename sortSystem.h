...
public:
    ...
    void init(int n, Type type)
    {
        ...
        {
        case Type::POSITIVE:
            std::cout << "sortType: POSITIVE" << std::endl;

            for (int i = 0; i < size; i++)
                m_vec.emplace_back(i);
            break;
        case Type::REVERSE:
            std::cout << "sortType: REVERSE" << std::endl;

            for (int i = size - 1; i >= 0; i--)
                m_vec.emplace_back(i);
            break;
        case Type::RANDOM:
            std::cout << "sortType: RANDOM" << std::endl;
...
private:
    ...
    void testTime(Func1 &&func1, Func2 &&func2)
    {
        ...
        std::cout << "Time expense: " << m_time.count() * 1.0 / ITERATIONS << " microseconds" << std::endl;
        std::cout << "Times of comparison: " << comparisonTimes << std::endl;
        std::cout << "Times of moves: " << moveTimes << std::endl;
    }
